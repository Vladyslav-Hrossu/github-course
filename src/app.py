...
activities = {
    ...
    "Soccer League": {
        "description": "Join peers for soccer training sessions and weekend matches",
        "schedule": "Tuesdays, Fridays, 4:00 PM - 5:45 PM",
        "max_participants": 22,
    ...
    "Drama Club": {
        "description": "Participate in theater productions, acting workshops, and performances",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["mia@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Develop problem solving and compete in mathematics contests",
